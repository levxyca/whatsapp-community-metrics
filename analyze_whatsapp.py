...
def process_whatsapp_export(file_path, start_date_str, end_date_str):
    ...
    excluded_senders = ['sender_one', 'sender_two']
...
start_date_str = '05/08/2024'  # Example start date
end_date_str = '12/08/2024'    # Example end date

process_whatsapp_export(file_path, start_date_str, end_date_str)
